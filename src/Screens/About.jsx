  ...
  return (
    <div className="w-full">
      ...
      <div className="w-full py-4 px-[4vw]">
        ...
        <div className="w-full h-[35vh] p-4 flex flex-row-reverse gap-5">
          <div className="w-[20%] h-full">
            <img className="w-[100%] h-full object-cover" src="https://s3-alpha-sig.figma.com/img/21d5/9f9e/aa243468d1b1f1742bdb55d897e54c48?Expires=1730678400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=XsMDf~lOlfHe9x-akAT~bRz~ReHecmP6OR-WsiwTKfTCIdqYHmmuwKAR3Q7zAuucc14CFHkaxkY29GgpF84qsI7nUKOF3EOrrNiidEjaVerzjLu-WN6ijHyR4uWVyBqRKEUKjF-3GqUiG~cb14me0L7FNKegB7Ms4E7HvXQgvfCddBQJ2LxyVfPH52qCRDtQxV4Jdy3D0CcS2INCgi27bW9-4uAw1w3~0qfThhOwgc7zKtgQJTZIHm-r5NnXR8WCiaDeSYeOExLs9c23zUS928u5LHOexIduiPgCGdMm0vlPcfjqxbj-6llSZze6G-1FivwPVbqVFJ~zhhdq6BM5CA__" alt="" />
          </div>
          <div className="w-full h-full flex flex-col py-8 gap-y-5 items-end pl-[3vw]">
            <h1 className="inria text-3xl text-[#AE1D1D] font-semibold w-full">User-Friendly Interface</h1>
            <p className=" inria text-xl px-[3vw]">Our platform is designed with simplicity in mind, making it easy for both residents and society managers to navigate and manage tasks without any technical hassle.</p>
          </div>
        </div>
        <div className="w-full flex justify-center">
        <div className="line w-[80%] ">
          <img src={line} alt="" style={{ transform: 'scaleX(-1)' }}/>
        </div>
        </div>
        <div className="w-full h-[35vh] p-4 flex gap-5">
          <div className="w-[20%] h-full">
            <img className="w-[100%] h-full object-cover" src="https://s3-alpha-sig.figma.com/img/239c/abc8/13d1ebc447104c13071bd442bdee5742?Expires=1730678400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=px3f1JL19ipm3tfQJUP~jg-zMifWRKRI8TT1~A3FdwEQSYBw7a3Jf2oM3hBinnAzlbMB~9PeZvQrb~BwD~V-9-9CuwNBBZciDzAOKUhVYX1c3gzp9tV9vUE8q2ynL5GDtR2EXSkjV7E~cPP-JcnkqTbny1HvvVeAAA53ogMD3o-e0N8Vr~eoZXqVncRjMHNFrCmToE5X3sWn5LR46DVxmokDxaquYr93X~9g6bs6iwOZgQl~YyX3ynMN0QTKMKwONtK9qqz3yD4H3mV4oEhAI0auaQNCVl6nXYqsc62VGNB1PCrJum2waVsiG-GxQFIc8ZSv1~rOCLLW7BXs89MYcA__" alt="" />
          </div>
          <div className="w-full h-full flex flex-col py-8 gap-y-5 items-end pl-[3vw]">
            <h1 className="inria text-3xl text-[#AE1D1D] font-semibold w-full">Advanced Security Features</h1>
            <p className=" inria text-xl px-[3vw]">With IoT-enabled gates, QR-based visitor passes, and real-time alerts, AanganConnect ensures that your society is always secure, providing peace of mind for residents and management alike.</p>
          </div>
        </div>
        <div className="w-full flex justify-center">
        <div className="line w-[80%] ">
        ...
        <div className="w-full h-[35vh] p-4 flex flex-row-reverse gap-5">
          <div className="w-[20%] h-full">
            <img className="w-[100%] h-full object-cover" src="https://s3-alpha-sig.figma.com/img/b545/0b4b/bb73d3ef5aadb10b82f33407e443be4f?Expires=1730678400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Vwmwgd12eV~ToQxDWG5jDz3DP5Suk1aQ2y~~EtsPf33HiW0QmU7FnYKDY3eo0j7T3dXeITitt8bW~KZk1QOY-rUbPnc7Bd35mdp81a9hCdXsBVfbgG9Ah7nsbM3IaIf5u~RXNs7mZuJBMekxAY9PIK5A8fOSkcCLUf8oDET-5eFo5z~cEcZmAP2PssC~-muPIEuLFRNKSoakigqXeac0Ieoj4gZGiRgniAqOohLnVOC3txVEbH0oDk7QVAB~pt9gM2sk9Wz7aUp7H03G4NEZ3wtMFRRs1MS41a5NRIRvsUvj6UMWrqdkZUDUKnGmoQTAvdANdEd1u1W9rMVLGgMmnA__" alt="" />
          </div>
          <div className="w-full h-full flex flex-col py-8 gap-y-5 items-end pl-[3vw]">
            <h1 className="inria text-3xl text-[#AE1D1D] font-semibold w-full">Real-Time Communication</h1>
            <p className=" inria text-xl px-[3vw]">Stay connected with instant updates, announcements, and notifications. Whether it’s a society notice or an emergency alert, communication is fast and reliable, keeping everyone informed.</p>
          </div>
        </div>
        <div className="w-full flex justify-center">
        <div className="line w-[80%] ">
        ...
        <div className="w-full h-[35vh] p-4 flex gap-5">
          <div className="w-[20%] h-full">
            <img className="w-[90%] h-full object-cover" src="https://s3-alpha-sig.figma.com/img/b8c2/c730/1bff8ec2d4d89213a1a490f232edd0be?Expires=1730678400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=MnWNQffKPqiM42w2fgg3qhNGH6v-e--hJvSGFWcP4hm95BhhjDhvm6n1b6MKYEI1nnCGHsjfOM1Zf7VHImms0mlzFdtmqCgQskN2OQ99jlgchLYsiOwJyMEZz5ND8PNvtIukuhsofDeSa14kM76DCzBvwkjK0P-uDTYTZnJ4GLog60nmE4rOvUnRYT4FxWE2Xb7WrhXkNlAzOsSCUtmJAp9~fGwTz9Ghi4p35zy2AZVwralGMRPxdwAD4xorIdeqpydu-KkjOnB-0UlU9MRi59NYVnxsewsoRx-1S648-EaxJGbcdS7IPc8NuOzULYVrWmroYs2ccf1K75-y75H9Sg__" alt="" />
          </div>
          <div className="w-full h-full flex flex-col py-8 gap-y-5 items-end pl-[3vw]">
            <h1 className="inria text-3xl text-[#AE1D1D] font-semibold w-full">Customizable for Your Needs</h1>
            <p className=" inria text-xl px-[3vw]">Every society is unique, and so are its needs. AanganConnect offers customizable tools and features, allowing you to tailor the platform according to your society’s specific requirements for seamless management.</p>
          </div>
        </div>
        </div>
      </div>
